...
| [03c2_competition_modeling](03c2_competition_modeling/README.md) | Closed | Competition-only nested model-family tuning over C0/C1/C2/C3; workstation run completed with CatBoost on GPU. |\n| [03c3_finalist_ensembles](03c3_finalist_ensembles/README.md) | Closed | Fixed equal-weight OOF ensemble review for the three 03C.2 finalists; E13 and E123 retained. |\n| [03c4_nested_stacking](03c4_nested_stacking/README.md) | Run pending | Leakage-safe nested stacking with 10 base learners, honest level-1 cross-fitting and low-capacity meta models. |
