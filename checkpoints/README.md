...
| [03_modeling](03_modeling/README.md) | In progress | 03A closed; 03B implementation is ready for local validation; 03C follows after 03B is reviewed. |
| [03b_empirical_feature_discovery](03b_empirical_feature_discovery/README.md) | Local validation pending | Canonical 335-feature X-only empirical layer plus leakage-safe fold-local target-aware expression discovery. |
