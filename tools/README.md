...
| `build_empirical_features_v1.py` | Target-free temporal-geometry / relative-condition / sensor-similarity layer | Checkpoint 03B |
...
Checkpoint 03 is open. Phase 03A is closed. Phase 03B builds `data/processed/empirical_features_v1/` and fold-local expression-discovery infrastructure. Model comparison is deferred to 03C and must reuse `reports/checkpoint_02/cv_folds.csv`.
