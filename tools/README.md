...
| `run_checkpoint_03c.py` | Fixed-fold clean/competition representation benchmark with Ridge10 and ExtraTrees | Checkpoint 03C.1 current |
...
Checkpoint 03 is open. 03A/03B are closed. 03C.1 now benchmarks representations on the frozen folds before broader model-family tuning.
