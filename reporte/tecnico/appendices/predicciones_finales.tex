...
La tabla de este apéndice reproduce el vector \emph{final post-05} de 59 predicciones,
redondeado a seis decimales únicamente para lectura humana. Checkpoint~05 terminó sin
promoción, por lo que el método sigue siendo Local04D y los valores coinciden con 04F.
La fuente canónica de cierre ahora es
\begin{center}
\artifact{reports/checkpoint_05/final_predictions.csv}.
\end{center}

Checkpoint~03D se ejecutó posteriormente como benchmark global y genera candidatos separados;
no sustituye este vector porque sus state/grouped RMSE no pertenecen al mismo protocolo
target-matched. No se deben copiar manualmente los valores de esta tabla para construir la
entrega.

\section{Vector final retenido por Checkpoint 05}

\begin{longtable}{lr}
\caption{Predicciones finales post-05; Checkpoint 05 retuvo exactamente Local04D.}
...
\section{Resumen descriptivo del vector final}
