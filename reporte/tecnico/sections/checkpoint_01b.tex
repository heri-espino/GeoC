...
CHIRPS v3 aporta precipitación diaria para 214 fechas entre abril y octubre de 2025 \citep{Funk2015CHIRPS}. Aunque su
...
WaPOR v3 aporta AETI y NPP en 21 periodos dekadales \citep{FAOWaPOR}. Dado que sus bandas representan tasas,
...
SoilGrids aporta 36 GeoTIFF: nueve propiedades por cuatro profundidades \citep{Poggio2021SoilGrids}:
...
La topografía combina el producto oficial de 120 m y el CEM estatal de INEGI \citep{INEGICEM} de
...
El archivo histórico SIAP cubre 2003--2025 \citep{SIAPDatos}. La llave municipal estable es
\begin{equation}
\mathrm{CVEGEO}
=
