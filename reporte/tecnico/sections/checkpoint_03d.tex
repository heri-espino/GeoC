...
\]
No se reabrió descubrimiento target-aware. El universo incluyó CatBoost
\citep{CatBoost2018} y XGBoost \citep{XGBoost2016} en GPU, LightGBM
\citep{LightGBM2017}, ExtraTrees \citep{Geurts2006}, HistGradientBoosting como
implementación de la familia de gradient boosting \citep{Friedman2001}, y controles
Ridge/PLS \citep{HoerlKennard1970,Wold2001}, para 23 pares representación--familia.
