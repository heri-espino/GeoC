...
\subsection{Nota posterior: apertura controlada de Checkpoint 05}

Checkpoint~04F permanece congelado como incumbent. Posteriormente se abrió una única hipótesis
nueva, documentada como Checkpoint~05: combinar la evidencia global de Checkpoint~03 con los
expertos local/grafo de Checkpoint~04 usando meta-predicciones completamente cross-fitted.
Esta apertura no invalida el cierre 04F; define un procedimiento explícito para intentar
superarlo. Si el gate LOSO de 05 no mejora simultáneamente mean y pooled RMSE, el vector 04F
permanece como salida final.
