...
| `join_agronomic_features` | function | `geocebada.features.agronomic` | Join the additive agronomic feature layer to a parcel-level base table. | `src/geocebada/features/agronomic.py` |
