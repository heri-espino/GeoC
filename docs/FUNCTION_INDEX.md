...
| `ConvexStackingRegressor` | class | `geocebada.evaluation.checkpoint03c4` | Fit nonnegative stacking weights constrained to sum to one. | `src/geocebada/evaluation/checkpoint03c4.py` |
| `MetaSearchSpec` | class | `geocebada.evaluation.checkpoint03c4` | One stacker estimator and its small tuning grid. | `src/geocebada/evaluation/checkpoint03c4.py` |
| `build_stacking_meta_features` | function | `geocebada.evaluation.checkpoint03c4` | Build target-free meta features from cross-fitted base predictions. | `src/geocebada/evaluation/checkpoint03c4.py` |
| `evaluate_nested_stacking` | function | `geocebada.evaluation.checkpoint03c4` | Run honest level-1 cross-fitting and untouched outer-fold stack evaluation. | `src/geocebada/evaluation/checkpoint03c4.py` |
| `summarize_stacking_results` | function | `geocebada.evaluation.checkpoint03c4` | Build pooled protocol metrics and cross-protocol robustness for stackers. | `src/geocebada/evaluation/checkpoint03c4.py` |
