...
| 2026-09-14 | ChatGPT | Onboarding reproducible con Conda | Crear un tutorial paso a paso para que el equipo ejecute el repositorio con la misma línea de Python y un kernel de Jupyter común | `environment.yml`, `docs/GETTING_STARTED.md`, actualización de `notebooks/README.md` y navegación Sphinx | Flujo basado en Python 3.11, instalación editable `.[dev,geo]` y kernel `Python (GeoCebada)`; pendiente de prueba manual en las computadoras del equipo |
