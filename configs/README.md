...
| `agronomic_features_v1.yaml` | Explicit target-free nonlinear/agronomic transformations over Feature Table v1 | Checkpoint 03A |
...
Checkpoint 03A has its own `agronomic_features_v1.yaml`; do not mutate the frozen Checkpoint 02 config. Phase 03B should receive its own model-experiment config.
