...
6. `checkpoints/03_modeling/README.md` and `checkpoints/03b_empirical_feature_discovery/README.md` — 03A closed; 03B local validation pending.
...
Do not replace confirmed project facts with guesses or generic ML assumptions. Checkpoints 01, 02 and 03A are closed. Checkpoint 03B implementation is in the repository and awaits workstation validation; do not start 03C until those outputs are reviewed.
